...
export function EmailConfirmForm() {
  ...
  return (
    <Card className="w-full max-w-email-form min-h-email-form flex flex-col justify-between bg-white border border-[#E5E5E5] rounded-3xl shadow-[0_2px_8px_rgba(0,0,0,0.08)] p-8 gap-8">
