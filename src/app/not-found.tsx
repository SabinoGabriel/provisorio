        ...
        <div className="flex flex-col items-center justify-center gap-20 md:gap-28">
          <div className="flex flex-wrap flex-col gap-10 md:gap-12 justify-center">
            <div className="flex flex-col justify-center gap-2">
              ...
              <p className="text-sm md:text-base font-thin dark:text-slate-400 text-slate-800">
                Erro 404 - Página não encontrada
              </p>
            </div>
            <p className="text-wrap max-w-[29rem]">
              Desculpe! O conteúdo que você procura pode ter sido removido, mas
              novas oportunidades sempre brotam. Que tal explorar nosso site e
              ver o que pode florescer para você?
            </p>
          </div>
